    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forum.postbase')),
                ('report_tyoe', models.ForeignKey(default=apps.forum.models.report.ReportType.get_default_type, on_delete=django.db.models.deletion.SET_DEFAULT, to='forum.reporttype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-post'],
