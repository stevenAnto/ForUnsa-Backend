    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, upload_to='posts', validators=[django.core.validators.FileExtensionValidator(['pdf', 'doc', 'docx'])])),
                ...
                ('section', models.ForeignKey(default=None, on_delete=models.SET(apps.forum.models.section.Section.get_default_section), to='forum.section')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(default=None, editable=False, on_delete=django.db.models.deletion.SET_DEFAULT, to='forum.section')),
            ],
            options={
                'ordering': ['-likes_count'],
            },
